...
-- Due the Error duplicate key value violates unique constraint "visits_pkey"
-- I need to drop the primary key constraint and add visit_date as primary key as well

-- Drop the primary key constraint
ALTER TABLE visits DROP CONSTRAINT visits_pkey;

-- Add visit_date as primary key
